...
function C.extend_palette()
    ...
    C.bg_dark = (O.transparent_bg and C.none) or C.taupe
    ...
    -- Borders
    C.border_fg = (O.transparent_bg and not O.bright_border and C.base.bg) or (O.bright_border and C.fg_hightlight) or C.gray.g3
